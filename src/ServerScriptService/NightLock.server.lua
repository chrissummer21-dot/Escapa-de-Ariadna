...
local NIGHT_HOUR = 2            -- 2:00 AM (ajusta entre 0â€“24)
local UPDATE_EVERY = 0          -- 0 = cada frame del servidor; o pon 1 para cada segundo

-- Ajustes opcionales para una noche mÃ¡s oscura/suave:
...
-- Si existe un ColorCorrection/Bloom, puedes dejarlos como estÃ©n.
